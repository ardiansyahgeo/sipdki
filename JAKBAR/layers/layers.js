...
var format_JAKBAR_5 = new ol.format.GeoJSON();
var features_JAKBAR_5 = format_JAKBAR_5.readFeatures(json_JAKBAR_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_JAKBAR_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_JAKBAR_5.addFeatures(features_JAKBAR_5);
var lyr_JAKBAR_5 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_JAKBAR_5, 
                style: style_JAKBAR_5,
                interactive: true,
                title: '<img src="styles/legend/JAKBAR_5.png" /> JAKBAR'
            });

lyr_GoogleHybrid_0.setVisible(true);lyr_ESRISatellite_1.setVisible(true);lyr_GoogleSatellite_2.setVisible(true);lyr_BatasKecamatan_3.setVisible(true);lyr_BatasKotaMadya_4.setVisible(true);lyr_JAKBAR_5.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_ESRISatellite_1,lyr_GoogleSatellite_2,lyr_BatasKecamatan_3,lyr_BatasKotaMadya_4,lyr_JAKBAR_5];
...
lyr_JAKBAR_5.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'NOURUT': 'NOURUT', 'ALAMAT_RUM': 'Alamat Rumah', 'NO__RUMAH': 'No Rumah', 'NO__FORM': 'No Formulir', 'NAMA_PENGH': 'Nama Penghuni', 'PENGELUARA': 'Terbit SIP', 'BERAKHIR': 'Akhir SIP', 'PEMILIK': 'Nama Pemilik', 'WADMRW': 'RW (tentatif)', 'WADMKD': 'Kelurahan', 'WADMKC': 'Kecamatan', 'WADMKK': 'Kota Madya', 'link': 'Rute', });
...
lyr_JAKBAR_5.set('fieldImages', {'OBJECTID': 'TextEdit', 'NOURUT': 'TextEdit', 'ALAMAT_RUM': 'TextEdit', 'NO__RUMAH': 'TextEdit', 'NO__FORM': 'TextEdit', 'NAMA_PENGH': 'TextEdit', 'PENGELUARA': 'DateTime', 'BERAKHIR': 'DateTime', 'PEMILIK': 'TextEdit', 'WADMRW': 'TextEdit', 'WADMKD': 'TextEdit', 'WADMKC': 'TextEdit', 'WADMKK': 'TextEdit', 'link': 'TextEdit', });
...
lyr_JAKBAR_5.set('fieldLabels', {'OBJECTID': 'inline label', 'NOURUT': 'inline label', 'ALAMAT_RUM': 'inline label', 'NO__RUMAH': 'inline label', 'NO__FORM': 'inline label', 'NAMA_PENGH': 'inline label', 'PENGELUARA': 'inline label', 'BERAKHIR': 'inline label', 'PEMILIK': 'inline label', 'WADMRW': 'inline label', 'WADMKD': 'inline label', 'WADMKC': 'inline label', 'WADMKK': 'inline label', 'link': 'inline label', });
lyr_JAKBAR_5.on('precompose', function(evt) {
